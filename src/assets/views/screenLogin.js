...
import { login, authGoogle, observer } from '../js/authFirebase.js';
import { validateEmail, validatePassword, validateInvalidEmail } from '../js/validateLogin.js';
...
export const screenLogin = () => {
  document.getElementById('root').innerHTML =
    ...
    <div id="containerForm" class="container">
      <form>
          ...
          <p id="error-invalid-email" class="err"></p>
  ...
  document.getElementById('btn-login').addEventListener('click', () => {
    ...
    let resultValidateEmailChecked = validateInvalidEmail(emailLogin, user);

    if (resultValidateEmail === true && resultValidatePassword === true) {
      login(emailLogin, passwordLogin);
    }
    if (resultValidateEmailChecked === false) {
      document.getElementById("error-invalid-email").innerHTML = `${errInvalidUser}`
    }
